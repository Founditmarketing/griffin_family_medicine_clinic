...
import imgDoctor from '../assets/all-staff.jpg';
        ...
        <div className="mb-24">
          ...
          >
            ...
            <p className="leading-relaxed mb-6">
              Griffin Family Medicine Clinic was founded with a simple mission: to provide high-quality, compassionate healthcare to the families of Central Louisiana. As a husband-and-wife team of board-certified physicians, Christopher and Amy Griffin have built a practice focused on treating every patient like family. For over two decades, we have been a proud cornerstone of the Cenla community, serving generations of patients through every stage of life.
            </p>
            <p className="leading-relaxed mb-6">
              We believe healthcare should feel personal, accessible, and centered around your whole well-being. Our practice combines the warmth of a traditional family-owned clinic with cutting-edge diagnostic medicine. True health isn't just the absence of disease — it's complete physical, mental, and social well-being. That means prioritizing rapid intervention when you are sick, and proactive preventative care when you are well.
            </p>
            <p className="leading-relaxed">
              Every day, our dedicated team of physicians and physician assistants brings decades of combined experience into the exam room. Whether you're visiting for an annual physical, managing a chronic condition, or coming in for an acute illness, we take the time to listen and tailor our approach to your unique needs. At Griffin Family Medicine, you aren't just a patient chart — you are family.
            </p>
          ...
          <div className="space-y-16 lg:space-y-24">
            ...
            >
              ...
              <div className="w-full lg:w-2/3">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4 mb-8">
                  <p>Christopher Griffin, MD is a board-certified Family Medicine Physician. Dr. Griffin is from Central Louisiana, having grown up in the Bunkie area. He has a Bachelor of Science degree from LSU in Baton Rouge and completed his medical residency training through LSUHSC-Shreveport.</p>
                  <p>He is married to Dr. Amy Griffin, who is also a board-certified Family Physician. Together, they have built a practice dedicated to comprehensive, relationship-based care for the entire family. They have two children, Olivia and Luke.</p>
            ...
            >
              ...
              <div className="w-full lg:w-2/3">
                ...
                <p className="text-medical-red font-bold uppercase tracking-widest text-sm mb-6">Family Physician</p>
                <div className="text-gray-600 leading-relaxed space-y-4 mb-8">
                  <p>Amy Griffin, MD is a board-certified Family Medicine Physician with a special interest in women's health, offering personalized care for every stage of life. She is originally from Baton Rouge and is a graduate of LSU. She has been practicing in this community for the past 16 years, having completed her residency training here in Alexandria through LSUHSC Shreveport.</p>
